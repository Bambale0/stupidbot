...
python3 scripts/regression_telegram_feed_links.py
python3 scripts/regression_model_provider_contracts.py
python3 scripts/regression_model_env_migration.py
python3 scripts/regression_resumable_broadcasts.py
python3 scripts/regression_operations_readiness.py
python3 scripts/regression_release_certification.py
